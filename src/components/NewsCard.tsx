  ...
  return (
    <>
      ...
      >
        ...
        {/* Error overlay — surfaces the real failure instead of a silent fallback */}
        {error && !isGenerating && (
          <div
          ...
          >
            <div className="flex flex-col items-center text-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[rgb(var(--red))]">
                <path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path>
                <line x1="12" y1="9" x2="12" y2="13"></line>
                <line x1="12" y1="17" x2="12.01" y2="17"></line>
              </svg>
              <p className="mt-2 font-medium text-white text-sm sm:text-base">Couldn&apos;t generate AI summary</p>
              <p className="mt-1 text-white/60 text-xs max-w-[16rem] line-clamp-3">{error}</p>
              <span className="mt-3 text-xs text-white/50 underline">Tap to dismiss, then click the card to retry</span>
            </div>
          </div>
        )}
